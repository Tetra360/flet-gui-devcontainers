    ...
    def __init__(self, task_name, task_status_change, task_delete):
        ...
        self.display_view = ft.Row(
            ...
            controls=[
                ...
                ft.Row(
                    ...
                    controls=[
                        ft.IconButton(
                            icon=ft.Icons.CREATE_OUTLINED,  # 修正
                            tooltip="Edit To-Do",
                            on_click=self.edit_clicked,
                        ),
                        ft.IconButton(
                            icon=ft.Icons.DELETE_OUTLINE,  # 修正
        ...
        self.edit_view = ft.Row(
            ...
            controls=[
                self.edit_name,
                ft.IconButton(
                    icon=ft.Icons.DONE_OUTLINE_OUTLINED,  # 修正
                    icon_color=ft.Colors.GREEN,  # 修正
    ...
    def __init__(self):
        ...
        self.controls = [
            ...
            ft.Row(
                controls=[
                    self.new_task,
                    ft.FloatingActionButton(icon=ft.Icons.ADD, on_click=self.add_clicked),  # 修正
                ],
            ),
            ft.Column(
                spacing=25,
